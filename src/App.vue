  ...
  <v-app>
    <v-app-bar
      ...
      >
        ...
        <v-app-bar-title class="text-white">Portfolio</v-app-bar-title>
        <v-spacer/>
          <v-btn icon dark color='white' >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <v-btn icon dark href="https://www.linkedin.com/in/bryce-watson-gatech" target="_blank" color='white' >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
